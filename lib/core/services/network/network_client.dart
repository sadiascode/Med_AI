...
class NetworkClient {
  ...
  Future<Map<String, String>> _getHeadersWithAuth() async {
    ...
    if (token != null) {
      ...
      print('⚠ No auth token available - request may fail');
    }
  ...
  NetworkResponse _parseResponse(Response response) {
    ...
    // Unauthorized - clear tokens and trigger callback
    ...
    // Other errors
      ...
      if (responseBody != null) {
        ...
        } else if (responseBody['non_field_errors'] != null) {
          errorMessage = responseBody['non_field_errors'].toString();
        }
      }
